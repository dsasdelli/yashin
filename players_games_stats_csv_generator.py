...
def gen_statistical_items(game, period, groupName=None) -> None | list:
            ...
            for game in games:
                ...
                game_stat = {
                    **base_game_stat,
                    ...
                    'homeTeamFoundationDateTimestamp': game['homeTeam']['foundationDateTimestamp'] if 'foundationDateTimestamp' in game['homeTeam'] else None,
                    # Home team score:
                    ...
                    'awayTeamFoundationDateTimestamp': game['awayTeam']['foundationDateTimestamp'] if 'foundationDateTimestamp' in game['awayTeam'] else None,
                    # Away team score:
